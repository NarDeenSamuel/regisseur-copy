...
@Component({
  selector: 'app-organization-space-step-2',
   imports: [NavbarComponent,CommonModule,FormsModule,RouterLink,SideBarComponent],
  templateUrl: './organization-space-step-2.component.html',
  styleUrl: './organization-space-step-2.component.css'
})
export class OrganizationSpaceStep2Component implements OnInit {
ngOnInit(): void {
