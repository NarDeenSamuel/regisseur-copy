...
@Component({
  selector: 'app-individual-artest-services',
   imports: [NavbarComponent,CommonModule,FormsModule,RouterLink,SideBarComponent],
  templateUrl: './individual-artest-services.component.html',
  styleUrl: './individual-artest-services.component.css'
})
export class IndividualArtestServicesComponent  {
