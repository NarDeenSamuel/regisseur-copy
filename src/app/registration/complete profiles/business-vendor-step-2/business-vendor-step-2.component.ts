...
@Component({
  selector: 'app-business-vendor-step-2',
   imports: [NavbarComponent,CommonModule,FormsModule,RouterLink,SideBarComponent],
  templateUrl: './business-vendor-step-2.component.html',
  styleUrl: './business-vendor-step-2.component.css'
})
export class BusinessVendorStep2Component  {
ngOnInit(): void {
