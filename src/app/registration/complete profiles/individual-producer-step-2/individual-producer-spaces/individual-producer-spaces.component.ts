...
@Component({
  selector: 'app-individual-producer-spaces',
   imports: [NavbarComponent,CommonModule,FormsModule,RouterLink,SideBarComponent],
  templateUrl: './individual-producer-spaces.component.html',
  styleUrl: './individual-producer-spaces.component.css'
})
export class IndividualProducerSpacesComponent implements OnInit {
ngOnInit(): void {
