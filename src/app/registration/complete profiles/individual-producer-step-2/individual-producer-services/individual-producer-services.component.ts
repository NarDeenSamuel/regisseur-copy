...
@Component({
  selector: 'app-individual-producer-services',
   imports: [NavbarComponent,CommonModule,FormsModule,RouterLink,SideBarComponent],
  templateUrl: './individual-producer-services.component.html',
  styleUrl: './individual-producer-services.component.css'
})
export class IndividualProducerServicesComponent {
ngOnInit(): void {
...
serviceCategories = [
 ...
 createRental(
  ...
  const payload = {
    ...
    coverImageUrl:'https://picsum.photos/1200/800',
