...
@Component({
  selector: 'app-individual-producer-interests',
   imports: [NavbarComponent,CommonModule,FormsModule,RouterLink,SideBarComponent],
  templateUrl: './individual-producer-interests.component.html',
  styleUrl: './individual-producer-interests.component.css'
})
export class IndividualProducerInterestsComponent {
