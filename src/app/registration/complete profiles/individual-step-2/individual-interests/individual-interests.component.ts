...
@Component({
  selector: 'app-individual-interests',
  imports: [
    CommonModule,
    FormsModule,
    NavbarComponent,
  ...
  templateUrl: './individual-interests.component.html',
  styleUrl: './individual-interests.component.css'
})
export class IndividualInterestsComponent {
